...
namespace SelfService\Guzzle\Common\Cache;
...
class Zf2CacheAdapter extends AbstractCacheAdapter
{
    ...
    /**
     * @param AbstractAdapter $cache   Zend Framework 2 cache adapter
     ...
     */
    public function __construct(AbstractAdapter $cache, array $defaultOptions = array())
    {
        $this->cache = $cache;
